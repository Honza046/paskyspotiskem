...
SORTIMENT_PAGE = {
    "cs": {
        ...
        "related_heading": "Další pásky z kategorie {category}",
    ...
    "en": {
        ...
        "related_heading": "More tapes from {category}",
    ...
    "de": {
        ...
        "related_heading": "Weitere Bänder aus {category}",
    ...
    "it": {
        ...
        "related_heading": "Altri nastri da {category}",
