...
def _benefit_text(locale: str, cs: str) -> str:
    ...
    patterns = (
        ...
        (r"^Přilnavost (.+), low-noise acrylic, easy tear a UV odolnost \((.+)\)\.$",
         {"en": "Adhesion {}, low-noise acrylic, easy tear and UV resistance ({}).",
          "de": "Klebkraft {}, leiser Acrylklebstoff, Easy-Tear und UV-Beständigkeit ({}).",
          "it": "Adesione {}, acrilico silenzioso, strappo facile e resistenza UV ({})."}),
