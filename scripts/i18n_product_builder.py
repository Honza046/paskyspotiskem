...
# ACRYL / HOT MELT detailed tech-spec schema (same value keys, different CS labels).
...
PARAM_VALUE_MAP: dict[str, dict[str, str]] = {
    ...
    "ACRYL (Low noise / Noisy)": {"en": "ACRYL (Low noise / Noisy)", "de": "ACRYL (Low noise / Noisy)", "it": "ACRYL (Low noise / Noisy)"},
