...
PARAM_VALUE_MAP: dict[str, dict[str, str]] = {
    ...
    "HOT MELT (super tack, +20 %)": {"en": "Hot melt (super tack, +20%)", "de": "Hot Melt (Super-Tack, +20 %)", "it": "Hot melt (super tack, +20%)"},
    "HOT MELT (tack+)": {"en": "HOT MELT (tack+)", "de": "HOT MELT (tack+)", "it": "HOT MELT (tack+)"},
    "28 / 32 µm": {"en": "28 / 32 µm", "de": "28 / 32 µm", "it": "28 / 32 µm"},
    ...
    "Akryl": {"en": "Akryl", "de": "Akryl", "it": "Akryl"},
    "Bezpečnostní (VOID)": {"en": "Security (VOID)", "de": "Sicherheit (VOID)", "it": "Sicurezza (VOID)"},
    "28 µm": {"en": "28 µm", "de": "28 µm", "it": "28 µm"},
    "28 / 32 / 35 µm": {"en": "28 / 32 / 35 µm", "de": "28 / 32 / 35 µm", "it": "28 / 32 / 35 µm"},
    "Akryl (Low noise)": {"en": "Akryl (Low noise)", "de": "Akryl (Low noise)", "it": "Akryl (Low noise)"},
    "Akryl (Noisy)": {"en": "Akryl (Noisy)", "de": "Akryl (Noisy)", "it": "Akryl (Noisy)"},
    ...
    "0 až +60 °C": {"en": "0 to +60 °C", "de": "0 bis +60 °C", "it": "0 a +60 °C"},
    "−10 až +60 °C": {"en": "−10 to +60 °C", "de": "−10 bis +60 °C", "it": "−10 a +60 °C"},
...
GALLERY_ITEMS = {
    "cs": {
        ...
        "irplast-warehouse-2": {"title": "Automatizovaný sklad Empoli", "description": "Pohled do automatizovaného skladu závodu Empoli s vysokohustotním skladováním.", "industry_label": "Výroba"},
    ...
    "en": {
        ...
        "irplast-warehouse-2": {"title": "Automated warehouse Empoli", "description": "View into the Empoli automated warehouse with high-density storage.", "industry_label": "Manufacturing"},
    ...
    "de": {
        ...
        "irplast-warehouse-2": {"title": "Automatisiertes Lager Empoli", "description": "Blick in das automatisierte Lager Empoli mit hochdichtem Lagern.", "industry_label": "Produktion"},
    ...
    "it": {
        ...
        "irplast-warehouse-2": {"title": "Magazzino automatizzato Empoli", "description": "Vista del magazzino automatizzato di Empoli con stoccaggio ad alta densità.", "industry_label": "Produzione"},
