...
CATEGORY_IT: dict[str, dict] = {
    ...
    "bopp-pasky": {
        ...
        "properties": {"Vysoká pevnost v tahu": "Elevata resistenza alla trazione", "ACRYL i HOT MELT": "ACRILICO e HOT MELT", "Dlouhá životnost": "Lunga durata"},
        "property_texts": {"Vysoká pevnost v tahu": "Film resistente che non si strappa durante l'imballaggio, neppure sotto tensione.", "ACRYL i HOT MELT": "Scegliete l'adesivo in base all'ambiente: svolgimento silenzioso o adesione rapida al freddo.", "Dlouhá životnost": "Resistenza ai raggi UV e all'invecchiamento per lo stoccaggio a lungo termine."},
...
SORTIMENT_PAGE = {
    "cs": {
        ...
        "no_print_body": "Pokud nepotřebujete logo na pásku, stejný materiál vám dodáme v nepotištěném provedení, ideální pro okamžité balení nebo skladové zásoby.",
    ...
    "en": {
        ...
        "no_print_body": "If you do not need a logo on the tape, we can supply the same material unprinted, ideal for immediate packing or stock.",
    ...
    "de": {
        ...
        "no_print_body": "Wenn Sie kein Logo auf dem Band benötigen, liefern wir dasselbe Material unbedruckt – ideal für den sofortigen Einsatz oder Lagerbestand.",
    ...
    "it": {
        ...
        "no_print_body": "Se non vi serve un logo sul nastro, possiamo fornire lo stesso materiale neutro, ideale per imballaggio immediato o scorte di magazzino.",
...
def _params_from_product(p: dict) -> dict[str, str]:
    params = p["params"]
    return {key: params[cs_key] for key, cs_key in PARAM_FIELD_KEYS}
...
def _build_cs_product(cat: dict, p: dict, ns: dict) -> tuple[str, dict]:
    ...
    return slug, {
        ...
        "spec_pills": _spec_pills(params_values),
        "params_labels": PARAM_LABELS["cs"],
        "ctas": {
            "hero": ctas["hero"],
