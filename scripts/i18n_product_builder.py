...
MIN_QTY_NOTE_MAP = {
    "Minimální množství od 360 ks (ACRYL).": {
        "en": "Minimum quantity from 360 pcs (ACRYL).",
        "de": "Mindestmenge ab 360 Stk. (ACRYL).",
        "it": "Quantità minima da 360 pz (ACRYL).",
    },
    ...
    "Dostupné v ACRYL i HOT MELT. Min. množství: ACRYL od 360 ks, HOT MELT od 504 ks.": {
        "en": "Available in ACRYL and HOT MELT. Min. quantity: ACRYL from 360 pcs, HOT MELT from 504 pcs.",
        "de": "Erhältlich in ACRYL und HOT MELT. Mindestmenge: ACRYL ab 360 Stk., HOT MELT ab 504 Stk.",
        "it": "Disponibile in ACRYL e HOT MELT. Quantità min.: ACRYL da 360 pz, HOT MELT da 504 pz.",
    },
}
...
PARAM_VALUE_MAP: dict[str, dict[str, str]] = {
    ...
    "ACRYL (Low noise / Noisy) / HOT MELT": {
        "en": "ACRYL (Low noise / Noisy) / HOT MELT",
        "de": "ACRYL (Low noise / Noisy) / HOT MELT",
        "it": "ACRYL (Low noise / Noisy) / HOT MELT",
    },
    "25 / 28 / 32 µm": {"en": "25 / 28 / 32 µm", "de": "25 / 28 / 32 µm", "it": "25 / 28 / 32 µm"},
    "21 µm": {"en": "21 µm", "de": "21 µm", "it": "21 µm"},
    "18 µm": {"en": "18 µm", "de": "18 µm", "it": "18 µm"},
    "21 µm (ACRYL) / 18 µm (HOT MELT)": {
        "en": "21 µm (ACRYL) / 18 µm (HOT MELT)",
        "de": "21 µm (ACRYL) / 18 µm (HOT MELT)",
        "it": "21 µm (ACRYL) / 18 µm (HOT MELT)",
    },
    "50 % regenerát": {
        "en": "50% regenerated",
        "de": "50 % regeneriert",
