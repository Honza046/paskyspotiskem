    ...
    return {
        ...
        "home": {
            ...
            "sustainability": {
                ...
                "title": "Udržitelné balení bez kompromisů v kvalitě",
                "subtitle": "Dodáváme obalové materiály, které dávají surovinám druhý život. Získejte plně funkční řešení pro vaši expedici s minimální zátěží pro životní prostředí.",
                "card1_title": "Udržitelné materiály s druhým životem",
                "card1_text": "V nabídce najdete <strong class=\"font-semibold text-slate-800\">ekologické papírové pásky z pevného kraftu</strong>, <strong class=\"font-semibold text-slate-800\">BOPET pásku z recyklovaných PET lahví</strong> i fólie s PCR/PIR odpadem. Plasty i papír vracíme do oběhu bez ztráty pevnosti.",
                "card2_title": "Čistá lepidla bez agresivní chemie",
                "card2_text": "Používáme jen <strong class=\"font-semibold text-slate-800\">akrylátovou disperzi na vodní bázi</strong> a <strong class=\"font-semibold text-slate-800\">HOT MELT technologii</strong> bez rozpouštědel. Bez toxických výparů, bezpečné pro pracovníky a se spolehlivou okamžitou i dlouhodobou lepivostí.",
                "card3_title": "Podpora udržitelné logistiky a ESG",
                "card3_text": "Pomáháme B2B partnerům snižovat uhlíkovou stopu balení, plnit ekologické normy a naplňovat ESG cíle. Odpovědné řešení, které posiluje reputaci značky u klientů i auditorů.",
            },
            "benefits": {
            ...
            "form": {
                ...
                "quantity_min_dynamic": "Minimální množství od {min} ks ({adhesive}, {width} mm).",
                "quantity_tip": "Dodání cca 3–4 týdny.",
                "quantity_tip_dynamic": "Dodání cca 3–4 týdny.",
                "quantity_tip_acryl": "Dodání cca 3–4 týdny.",
                "quantity_tip_hotmelt": "Dodání cca 3–4 týdny.",
                ...
                "sample_address_heading": "Adresa dodání vzorku",
                "sample_address_hint": "Pro zaslání testovacího vzorku potřebujeme doručovací adresu.",
                "delivery_street_label": "Ulice a číslo",
                "delivery_city_label": "Město",
                "delivery_zip_label": "PSČ",
        ...
        "sortiment": {
            "ui": {
                ...
                "filter": "Filtr",
                "clear_all": "Vymazat vše",
                "search_label": "Hledat pásky a firmy",
                "search_placeholder": "Hledat pásky, firmy…",
                "results_title": "Nalezené výsledky",
                "empty": "Nic neodpovídá hledání ani filtrům. Zkuste jiné klíčové slovo nebo ubrat filtr.",
            ...
            "filters": {
                ...
                "resistance": {
                    "label": "Odolnost",
                    "mrazuvzdorne": "Mrazuvzdorné (do −20 °C)",
        ...
        "js": {
            ...
            "sortiment": {
                ...
                "ref_one": "1 reference",
                "ref_few": "{n} reference",
                "ref_many": "{n} referencí",
                "results_mixed": "{n} výsledků",
                "detail": "Detail",
                "inquire": "Poptat",
                "gallery_ref": "Reference",
                "open_gallery": "Otevřít v galerii →",
                "tag_eco": "ECO",
                "tag_pet85": "85% z PET",
                "tag_cold": "-20 °C",
                "tag_hot": "Vysoké teploty",
                "tag_chem": "Chemická odolnost",
                "tag_machines": "Stroje",
                "tag_hand": "Ruční",
            },
            "form": {
    ...
    return {
        ...
        "home": {
            ...
            "sustainability": {
                ...
                "title": "Sustainable packaging without compromising quality",
                "subtitle": "We supply packaging materials that give raw materials a second life. Get a fully functional solution for your shipping with minimal environmental impact.",
                "card1_title": "Sustainable materials with a second life",
                "card1_text": "Our range includes <strong class=\"font-semibold text-slate-800\">eco-friendly kraft paper tapes</strong>, <strong class=\"font-semibold text-slate-800\">BOPET tape from recycled PET bottles</strong>, and films with PCR/PIR waste. We return plastics and paper to the loop without losing strength.",
                "card2_title": "Clean adhesives without aggressive chemicals",
                "card2_text": "We use only <strong class=\"font-semibold text-slate-800\">water-based acrylic dispersion</strong> and <strong class=\"font-semibold text-slate-800\">HOT MELT technology</strong> without solvents. No toxic vapours, safe for packing-line staff, with reliable instant and long-term adhesion.",
                "card3_title": "Supporting sustainable logistics and ESG",
                "card3_text": "We help B2B partners cut packaging carbon footprint, meet environmental standards and hit ESG goals. A responsible solution that strengthens your brand with clients and auditors.",
            },
            "benefits": {
            ...
            "form": {
                ...
                "quantity_min_dynamic": "Minimum quantity from {min} pcs ({adhesive}, {width} mm).",
                "quantity_tip": "Delivery approx. 3–4 weeks.",
                "quantity_tip_dynamic": "Delivery approx. 3–4 weeks.",
                "quantity_tip_acryl": "Delivery approx. 3–4 weeks.",
                "quantity_tip_hotmelt": "Delivery approx. 3–4 weeks.",
                ...
                "sample_address_heading": "Sample delivery address",
                "sample_address_hint": "We need a delivery address to send the test sample.",
                "delivery_street_label": "Street and number",
                "delivery_city_label": "City",
                "delivery_zip_label": "ZIP / Postal code",
        ...
        "sortiment": {
            "ui": {
                ...
                "filter": "Filter",
                "clear_all": "Clear all",
                "search_label": "Search tapes and companies",
                "search_placeholder": "Search tapes, companies…",
                "results_title": "Matching results",
                "empty": "Nothing matches your search or filters. Try another keyword or remove a filter.",
            ...
            "filters": {
                ...
                "resistance": {
                    "label": "Resistance",
                    "mrazuvzdorne": "Cold-resistant (down to −20 °C)",
        ...
        "js": {
            ...
            "sortiment": {
                ...
                "ref_one": "1 reference",
                "ref_few": "{n} references",
                "ref_many": "{n} references",
                "results_mixed": "{n} results",
                "detail": "Details",
                "inquire": "Inquire",
                "gallery_ref": "Reference",
                ...
                "tag_pet85": "85% PET",
                "tag_cold": "-20 °C",
                "tag_hot": "High temperatures",
                "tag_chem": "Chemical resistance",
                "tag_machines": "Machines",
                "tag_hand": "Manual",
            },
            "form": {
                "step_label": "Step {current} of {total}",
    ...
    return {
        ...
        "home": {
            ...
            "sustainability": {
                ...
                "title": "Nachhaltige Verpackung ohne Kompromisse bei der Qualität",
                "subtitle": "Wir liefern Verpackungsmaterialien, die Rohstoffen ein zweites Leben geben. Holen Sie sich eine voll funktionsfähige Lösung für Ihren Versand mit minimaler Umweltbelastung.",
                "card1_title": "Nachhaltige Materialien mit zweitem Leben",
                "card1_text": "Im Sortiment: <strong class=\"font-semibold text-slate-800\">ökologische Kraftpapier-Klebebänder</strong>, <strong class=\"font-semibold text-slate-800\">BOPET-Band aus recycelten PET-Flaschen</strong> und Folien mit PCR/PIR-Abfall. Kunststoffe und Papier zurück in den Kreislauf – ohne Verlust an Festigkeit.",
                "card2_title": "Saubere Klebstoffe ohne aggressive Chemie",
                "card2_text": "Nur <strong class=\"font-semibold text-slate-800\">Acrylatdispersion auf Wasserbasis</strong> und <strong class=\"font-semibold text-slate-800\">HOT-MELT-Technologie</strong> ohne Lösungsmittel. Keine giftigen Dämpfe, sicher für die Packlinie, mit sofortiger und langfristiger Klebkraft.",
                "card3_title": "Unterstützung nachhaltiger Logistik und ESG",
                "card3_text": "Wir helfen B2B-Partnern, den CO₂-Fußabdruck der Verpackung zu senken, Umweltnormen zu erfüllen und ESG-Ziele zu erreichen. Eine verantwortungsvolle Lösung, die den Markenruf bei Kunden und Auditoren stärkt.",
            },
            "benefits": {
            ...
            "form": {
                ...
                "quantity_min_dynamic": "Mindestmenge ab {min} Stk. ({adhesive}, {width} mm).",
                "quantity_tip": "Lieferzeit ca. 3–4 Wochen.",
                "quantity_tip_dynamic": "Lieferzeit ca. 3–4 Wochen.",
                "quantity_tip_acryl": "Lieferzeit ca. 3–4 Wochen.",
                "quantity_tip_hotmelt": "Lieferzeit ca. 3–4 Wochen.",
                ...
                "sample_address_heading": "Lieferadresse für das Muster",
                "sample_address_hint": "Für den Versand des Testmusters benötigen wir eine Lieferadresse.",
                "delivery_street_label": "Straße und Hausnummer",
                "delivery_city_label": "Stadt",
                "delivery_zip_label": "PLZ",
        ...
        "sortiment": {
            "ui": {
                ...
                "filter": "Filter",
                "clear_all": "Alle löschen",
                "search_label": "Bänder und Firmen suchen",
                "search_placeholder": "Bänder, Firmen suchen…",
                "results_title": "Gefundene Ergebnisse",
                "empty": "Nichts entspricht der Suche oder den Filtern. Versuchen Sie ein anderes Stichwort oder entfernen Sie einen Filter.",
            ...
            "filters": {
                ...
                "resistance": {
                    "label": "Beständigkeit",
                    "mrazuvzdorne": "Kältebeständig (bis −20 °C)",
        ...
        "js": {
            ...
            "sortiment": {
                ...
                "ref_one": "1 Referenz",
                "ref_few": "{n} Referenzen",
                "ref_many": "{n} Referenzen",
                "results_mixed": "{n} Ergebnisse",
                "detail": "Details",
                "inquire": "Anfragen",
                "gallery_ref": "Referenz",
                "open_gallery": "In der Galerie öffnen →",
                "tag_eco": "ECO",
                "tag_pet85": "85% PET",
                "tag_cold": "-20 °C",
                "tag_hot": "Hohe Temperaturen",
                "tag_chem": "Chemische Beständigkeit",
                "tag_machines": "Maschinen",
                "tag_hand": "Hand",
            },
            "form": {
                "step_label": "Schritt {current} von {total}",
    ...
    it["home"]["sustainability"].update(
        {
            ...
            "title": "Imballaggio sostenibile senza compromessi sulla qualità",
            "subtitle": "Forniamo materiali di imballaggio che danno alle materie prime una seconda vita. Ottenete una soluzione pienamente funzionale per le vostre spedizioni con il minimo impatto ambientale.",
            "card1_title": "Materiali sostenibili con una seconda vita",
            "card1_text": "Nella gamma: <strong class=\"font-semibold text-slate-800\">nastri di carta kraft ecologici</strong>, <strong class=\"font-semibold text-slate-800\">nastro BOPET da bottiglie PET riciclate</strong> e film con rifiuti PCR/PIR. Plastiche e carta tornano nel ciclo senza perdita di resistenza.",
            "card2_title": "Adesivi puliti senza chimica aggressiva",
            "card2_text": "Solo <strong class=\"font-semibold text-slate-800\">dispersione acrilica a base d’acqua</strong> e <strong class=\"font-semibold text-slate-800\">tecnologia HOT MELT</strong> senza solventi. Niente vapori tossici, sicuri per gli operatori, con adesione immediata e duratura.",
            "card3_title": "Supporto alla logistica sostenibile e ESG",
            "card3_text": "Aiutiamo i partner B2B a ridurre l’impronta di carbonio del packaging, rispettare le norme ambientali e raggiungere gli obiettivi ESG. Una soluzione responsabile che rafforza la reputazione del brand.",
        }
    )
    ...
    it["home"]["form"].update(
        {
            ...
            "quantity_min_dynamic": "Quantità minima da {min} pz ({adhesive}, {width} mm).",
            "quantity_tip": "Consegna circa 3–4 settimane.",
            "quantity_tip_dynamic": "Consegna circa 3–4 settimane.",
            "quantity_tip_acryl": "Consegna circa 3–4 settimane.",
            "quantity_tip_hotmelt": "Consegna circa 3–4 settimane.",
            ...
            "sample_address_heading": "Indirizzo di consegna del campione",
            "sample_address_hint": "Per inviare il campione di prova ci serve un indirizzo di consegna.",
            "delivery_street_label": "Via e numero",
            "delivery_city_label": "Città",
            "delivery_zip_label": "CAP",
    ...
    it["sortiment"]["ui"].update(
        {
            ...
            "search_label": "Cerca nastri e aziende",
            "search_placeholder": "Cerca nastri, aziende…",
            "results_title": "Risultati trovati",
            "empty": "Niente corrisponde alla ricerca o ai filtri. Provate un'altra parola chiave o rimuovete un filtro.",
    ...
    it["js"]["sortiment"].update(
        {
            ...
            "ref_one": "1 referenza",
            "ref_few": "{n} referenze",
            "ref_many": "{n} referenze",
            "results_mixed": "{n} risultati",
            "detail": "Dettagli",
            "inquire": "Richiedi",
            "gallery_ref": "Referenza",
            "open_gallery": "Apri in galleria →",
            "tag_eco": "ECO",
            "tag_pet85": "85% PET",
            "tag_cold": "-20 °C",
            "tag_hot": "Alte temperature",
            "tag_chem": "Resistenza chimica",
            "tag_machines": "Macchine",
            "tag_hand": "Manuale",
        }
    )
